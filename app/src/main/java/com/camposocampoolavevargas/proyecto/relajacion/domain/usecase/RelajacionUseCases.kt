...
class IniciarSesionRelajacionUseCase(private val repository: RelajacionRepository) {
...
class CompletarSesionRelajacionUseCase(private val repository: RelajacionRepository) {
...
class InterrumpirSesionRelajacionUseCase(private val repository: RelajacionRepository) {
