...
/**
 * Screen for Login (RF01 — Inicio de sesión simplificado con soporte de Google).
 */
    ...
    val googleLauncher = rememberLauncherForActivityResult(
        ...
        try {
            ...
            if (googleEmail != null) {
                ...
                localError = "No se pudo obtener el correo de la cuenta de Google."
            }
        ...
        Scaffold(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Monitorea tus hábitos de sueño y optimiza tu ritmo circadiano de forma offline.",
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            OutlinedTextField(
                                value = emailOrPhone,
                                onValueChange = { emailOrPhone = it; localError = null },
                                label = { Text("Correo o número de teléfono") },
                                placeholder = { Text("Ej: correo@u.cl o +56912345678") },
                                modifier = Modifier.fillMaxWidth(),
                                singleLine = true
                            )
                    ...
                    // Show error messages
                    val currentError = localError ?: (loginState as? UiState.Error)?.message
                    ...
                    if (loginState is UiState.Loading) {
                        ...
                        OutlinedButton(
                            ...
                            Row(
                                ...
                                Text(text = "Iniciar sesión con Google", fontSize = 15.sp, fontWeight = FontWeight.Bold)
                            }
                        }
                    }
